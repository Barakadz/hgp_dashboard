...
var element = document.getElementById("bna");
  ...
  var element = document.getElementById("com_nv");
  element.classList.add("active");
    ...
    <div class="content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
<div class="col">
       <center><h2>Voir et Modifier Les Commentaires</h2><hr></center> 
...
<div class="container-fuild">
            <table id="example" class="table" style="margin: auto;">
              <thead>
                ...
                <th data-priority="2">commentaire</th>
                <th data-priority="2">id_annonce</th>
